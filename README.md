...
|---|---|---|---|
| `favicon` | Pestaña del navegador | 64x64px | `.png` fondo transparente |
| `logo_icon` | Nav / encabezado (arriba izquierda) | 200x200px | `.png` fondo transparente |
| `logo_completo` | Footer (abajo, versión blanca con texto) | 400x80px | `.png` fondo transparente |
| `og_image` | Preview al compartir el link en WhatsApp, Facebook, LinkedIn y Twitter/X | 1200x630px | `.jpg` o `.png` |

> **Importante:** Los logos necesitan fondo transparente para verse bien sobre los fondos de la web.
> Cada archivo aparece en un lugar independiente — no se comparten.
> La `og_image` puede ser una captura de la web, el logo sobre fondo azul o cualquier imagen que represente la agencia.
...
|---|---|---|---|
| `portfolio_01` | Card 1 (primera posición) | 800x460px | Captura o imagen del cliente |
| `portfolio_02` | Card 2 (segunda posición) | 800x460px | Captura o imagen del cliente |
| `portfolio_03` | Card 3 (tercera posición) | 800x460px | Captura o imagen del cliente |
| `portfolio_04` | Card 4 (cuarta posición) | 800x460px | Captura o imagen del cliente |
